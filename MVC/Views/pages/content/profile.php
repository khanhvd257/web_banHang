                        ...
                        <div class="row m-l-0 m-r-0">
                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                <div class="card-block text-center text-white">
                                    ...
                                    <input disabled class="f-w-600 m-b-10 inputCss " style="  background: none;  border: none;  color: white;   FONT-SIZE: 22PX;   font-family: monospace;   
                                ...
                                <form action="" method="post">
                                    <div class="card-block">
                                        <div class="row" style="justify-content: space-between;">
                                            ...
                                            <div class="col-sm-2">
                                                <button id="btnEDIT" type="button" class="btn btn-primary btnEdit" onclick="enableForm()">Chỉnh sửa</button>
                                        ...
                                        <div class="row" style="justify-content: space-between;">
                                            <div class="col-sm-3">
                                                ...
                                                <input disabled name="txtEditTen" name="txtEditTen" class=" inputCss text-muted f-w-400" id="1xx" value="<?php echo $data['dataUser']['loginName'] ?>" />
                                            </div>
                                            <div class="col-sm-3" style="TEXT-ALIGN: center;">
                                                <p class="m-b-10 ">Loại Tài khoản</p>
                                                <input disabled name="" class=" inputCss text-muted txt_cennter" value="<?php if(($data['dataUser']['roleName'])==0) echo "User"; else echo "Admin"  ?>" />
