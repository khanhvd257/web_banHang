...
if (isset($_POST['btnLuu'])) {
	...
	$sql = "UPDATE tblusers Set loginName = '$loginName', password = '$password',fullName = '$fullName',gioiTinh = '$gioiTinh',
		soDienThoai= '$soDienThoai',email= '$email',diaChi= '$diaChi',ngaySinh= '$ngaySinh' Where userID='$userID'";
	$kq = mysqli_query($con, $sql);	
	if ($kq) {
		...
		<form method="post">
			<table  class="table" width="100%" style="padding-top: 50px;" >
				...
				<tr>
					...
					<td>
						<input class="dd1" type="text" name="txtuserID" value="<?php echo $kq1['userID'] ?>" disable>
					</td>
