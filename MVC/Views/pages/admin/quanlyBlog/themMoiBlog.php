            ...
            <div class="row" style="margin-left: 500px; display:block;">
                <div class="col-12">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <table>
                            <tr>
                                <td class="css_lable">Tên Blog: </td>
                                <td>
                                    <input style="margin-bottom: 10px;width:100%" type="text" name="txtTenBlog" id="">
                                </td>
                            </tr>
                            <br>
                            <tr>
                                <td class="css_lable">Nội Dung: </td>
                                <td>
                                    <textarea style="margin-bottom: 10px;width:100%" type="text" name="txtNoiDung" rows="5"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td class="css_lable">Thời Gian: </td>
                                <td style="width:100%">
                                    <input style="margin-bottom: 10px;" type="date" name="txtDate">
                                </td>
                            </tr>
                            <tr>
                                <td class="css_lable"> Upload image: </td>
                                <td>
